...
expName = 'stroopeffect_solo'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/vaishnavipatel/Downloads/stroopeffect_solo_lastrun.py',
        ...
        for thisPractice_trial in practice_trials:
            ...
            while continueRoutine:
                ...
                if key_resp.status == STARTED and not waitOnFlip:
                    theseKeys = key_resp.getKeys(keyList=['left','down','right'], ignoreKeys=["escape"], waitRelease=False)
